...
/**
 * Created by zhangxiaoyu01 on 2016/12/6.
 */
...
public class RoundImageViewByXfermode extends ImageView {
    ...
    public RoundImageViewByXfermode(Context context, AttributeSet attrs) {
        ...
        mBorderRadius = a.getDimensionPixelSize(R.styleable.RoundImageViewByXfermode_borderRadius, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, BORDER_RADIUS_DEFAULT,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (null == bitmap || bitmap.isRecycled()) {
            ...
            if (drawable != null) {
                ...
                if (type == TYPE_ROUND) {
                    //如果图片的宽或者高与view的宽高不匹配，计算出需要缩放的比例；缩放后的图片的宽高，一定要大于我们的view的宽高；所以我们这里取大值
